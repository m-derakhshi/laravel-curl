...
================
[![license](https://img.shields.io/github/license/mderakhshi/laravel-curl.svg)]()
[![Latest Version on Packagist](https://img.shields.io/packagist/v/mderakhshi/laravel-curl.svg?style=flat-square)](https://packagist.org/packages/mderakhshi/laravel-curl)
[![Total Downloads](https://img.shields.io/packagist/dt/mderakhshi/laravel-curl.svg?style=flat-square)](https://packagist.org/packages/mderakhshi/laravel-curl)
...
`mderakhshi\curl\src\mderakhshi\Curl\Builder.php`. This class has extensive doc blocks that contain all the necessary information
